...
## MFCC를 CNN 모델링 하여 classify하기(or mel spectogram + CNN)
...
라는 5개의 문장을 tfidf를 통해 추출했다. 이 문장에서 MFCC를 추출하여 CNN 모델링을 만들어 clssifier하고 Input으로 주어진 sentence가 모델에서 가장 유사한 I love you를 output 해준다.
